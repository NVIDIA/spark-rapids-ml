...
mvn clean package
```
Then `rapids-4-spark-ml_2.12-23.12.1-SNAPSHOT.jar` will be generated under `target` folder.
...
```bash
ML_JAR="target/rapids-4-spark-ml_2.12-23.12.1-SNAPSHOT.jar"
PLUGIN_JAR="~/.m2/repository/com/nvidia/rapids-4-spark_2.12/23.12.1/rapids-4-spark_2.12-23.12.1.jar"
